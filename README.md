...
> This repository intentionally omits exact performance numbers and dataset-specific proprietary values. Insert your own metrics after running the provided evaluation scripts.
...
- Deterministic, scriptable preprocessing & feature extraction (no hidden notebook-only logic).
...
(You may add your measured impact estimates here.)
